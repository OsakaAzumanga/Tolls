...
class Oxima():
    ...
    def __init__(self,arithmos_kykloforias,eidos_oximatos)
    self.arithmos_kykloforias=arithmos_kykloforias
    ...
    self.kwdikos=kwdikos #Αναφέρομαι στον κωδικό της εκάστοτε ePass
class Epivatiko(Oxima):
    ...
    def __init__(self.arithmos_kykloforias,eidos_oximatos,kwdikos)
